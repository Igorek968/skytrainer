...
## Push-напоминания (уроки + события за ~1 ч)
...
| Закрытие прошедших событий + автовыкладывание (сдвиг даты) | `GET /api/cron/expire-events` | каждый час (после полуночи сдвигает `repeatDaily`) |
