...
export function renderClientOfferHtml(): string {
  ...
  <p>
    ...
    2.2. Фактическим исполнителем является Инструктор. Агент не оказывает обучающие услуги, а выступает посредником.<br />
    2.3. Перечень Инструкторов, стоимость и расписание размещены на Сайте.<br />
    2.4. Договор на обучение заключается между Клиентом и выбранным Инструктором; Агент не является стороной договора на обучение.<br />
    2.5. Договор Клиент–Инструктор — с момента принятия заказа Инструктором на Сайте.
  </p>
  ...
  <p>Агент не отвечает за качество услуг Инструктора, но содействует в разрешении споров.</p>
...
export function renderInstructorAgencyOfferHtml(): string {
  ...
  <h2>6–8. Реферальная программа, ПДн, реквизиты</h2>
  <p>
