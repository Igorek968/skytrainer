    ...
    <LegalDocLayout title="Договор-оферта на оказание услуг по подбору инструктора">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          оформления бронирования и оплаты. Сайт сам по себе не является исполнителем услуг обучения и тренировок.
          <br />
          ...
          индивидуального предпринимателя, оказывающее услуги по обучению и тренировкам в направлениях, указанных в
          профиле на Сайте.
          <br />
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          2.4. Договор на оказание <strong>Услуг Инструктора</strong> (обучение и проведение занятия) заключается{" "}
        ...
        <p className="text-muted-foreground">
          ...
          расчёты). Обучающие услуги оказывает только Инструктор; Агент не контролирует процесс занятия на месте его
          проведения.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          организует занятия, не руководит действиями Клиента и Инструктора во время урока и не выступает организатором
          активного отдыха.
        </p>
        <p className="text-muted-foreground">
          6.4. Занятия спортом и активным отдыхом связаны с <strong>повышенным риском травм</strong> и иного вреда
          здоровью.
