    ...
    <LegalDocLayout title="Договор бронирования услуг (публичная оферта) о предоставлении платных услуг">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          <strong>{PLATFORM_FEE_PERCENT}%</strong> от стоимости занятия (или стоимости участия в Событии),
          удерживаемое Исполнителем из суммы, оплаченной Клиентом.
          <br />
          <strong>Событие</strong> — групповое или индивидуальное занятие с фиксированным временем (мастер-класс,
          выезд, тренировка), размещённое Инструктором в разделе «События» на Сайте.
          <br />
          ...
          . Сайт является <strong>информационной площадкой</strong> для поиска Инструкторов и Событий.
          <br />
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          подтверждения записи на Событие в порядке раздела 8.
        </p>
        <p className="text-muted-foreground">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          5.3. <strong>События.</strong> Стоимость участия также включает Комиссию Агента{" "}
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          имущества и иные последствия при оказании Услуг Инструктора или участии в Событии, за исключением
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold">8. События</h2>
        <p className="text-muted-foreground">
          8.1. Событие создаётся Инструктором с указанием даты, времени, места, стоимости и лимита мест.
        </p>
        <p className="text-muted-foreground">
          8.2. Запись оформляется на Сайте с согласием с настоящей Офертой и Политикой ПДн. Для платных событий
          место бронируется после оплаты через ЮKassa (предоплата при записи). Бесплатные события подтверждаются
          сразу после согласия с условиями.
        </p>
        <p className="text-muted-foreground">
        ...
        <p className="text-muted-foreground">
          8.4. Отмена События Инструктором — полный возврат оплатившим участникам. Неявка Инструктора — полный
          возврат клиенту и штраф <strong>{INSTRUCTOR_NO_SHOW_PENALTY_PERCENT}%</strong> с Инструктора.
        </p>
        <p className="text-muted-foreground">
          8.5. Комиссия Агента по событиям — <strong>{PLATFORM_FEE_PERCENT}%</strong> от стоимости участия каждого
