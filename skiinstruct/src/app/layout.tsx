...
export const metadata: Metadata = {
  ...
  icons: {
    ...
    apple: [{ url: "/apple-touch-icon.png?v=lockup1", sizes: "180x180", type: "image/png" }],
  },
  openGraph: {
    type: "website",
    locale: "ru_RU",
    ...
    images: [
      {
        url: "/brand/press/logo-horizontal-on-white.png?v=lockup1",
        width: 1099,
        height: 516,
        alt: appName,
      },
  ...
  twitter: {
    ...
    title: SEO_PAGES.home.title,
    description: SEO_PAGES.home.description,
    images: ["/brand/press/logo-horizontal-on-white.png?v=lockup1"],
  },
};
