    ...
    <LegalDocLayout title="Политика обработки персональных данных">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          проведения занятия или мероприятия. После принятия заявки и оплаты (либо бесплатной записи){" "}
          <strong>Клиенту</strong> может быть показан телефон Инструктора, а Инструктору — телефон Клиента, только по
          явному запросу в интерфейсе заказа/записи («Позвонить»), для связи по конкретной услуге. Номер не публикуется
          в открытой ленте мероприятий.
        </p>
        <p className="text-muted-foreground">
