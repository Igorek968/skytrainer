    ...
    <LegalDocLayout title="Политика обработки персональных данных">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          событие, а также при регистрации/заполнении анкеты инструктора). Геолокация — отдельное согласие
          браузера.
        </p>
        <p className="text-muted-foreground">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          занятия или события. По заказу связь Инструктора с Клиентом — через чат (телефон Клиента Инструктору не
          раскрывается). <strong>Клиенту</strong> после оплаты может быть показан телефон Инструктора по явному запросу
          («Позвонить»). По записи на событие телефон второй стороны может быть доступен участникам активной заявки
          по запросу в интерфейсе, также доступен чат. Номер не публикуется в открытой ленте событий.
        </p>
        <p className="text-muted-foreground">
