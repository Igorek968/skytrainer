          ...
          <div className="mt-4 space-y-4">
            ...
            <div className="rounded-md border border-border bg-muted/30 p-3 text-xs">
              ...
              {cardQuery.isLoading ? (
                ...
                <p className="mt-1 text-muted-foreground">
                  Сейчас доступна разовая оплата в ЮKassa без сохранения карты. Привязка включается, когда магазин
                  принимает автоплатежи.
                </p>
              ) : (
                <p className="mt-1 text-muted-foreground">
                  Карта не привязана. Привяжите её здесь (проверка карты без списания) или при первом заказе — ЮKassa
                  сохранит способ оплаты для следующих уроков и событий. Отвязать можно в любой момент кнопкой ниже.
                </p>
              )}
