...
- [x] Автовозвраты при отмене (24ч / 2–24ч / &lt;2ч), опоздание 15 мин, превью перед отменой
...
- [ ] Прогон сценариев: гость → заказ → оплата; клиент — заказы и ETA; инструктор — онлайн, гео, принятие; админ — модерация
